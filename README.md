...
6. Updates `January.md` file in the root directory with the contents of `Day010.md`.
7. Updated files:
   1. `./videos.txt`
   2. `./January.md`
...
1. Updates markdown file `Day021.md` in the `January` subdirectory.
   1. This markdown file has a link to the Youtube video.
   2. It also has AI-Generated summary of the podcast.
2. Generates image file `<videoid>.jpg` in the `January/jpgs` directory.
3. Updates `January.md` file in the root directory with the contents of `Day021.md`.
4. Updated files:
   1. `January/Day021.md`
   2. `./January.md`
5. Created files:
...
8. [genmonth](#genmonth)
9. [lintall](#lintall)
10. [replaceemojis](#replaceemojis)
11. [removeallsnippets](#removeallsnippets)
12. [findsnippetfiles](#findsnippetfiles)
13. [genmdfromvids](#genmdfromvids)
14. [addsnippets](#addsnippets)
15. [genvidthmd](#genvidthmd)
16. [genoverlay](#genoverlay)
17. [getgeminimodels](#getgeminimodels)
18. [annotatejpg](#annotatejpg)
19. [removesnippets](#removesnippets)
20. [addvideotoday](#addvideotoday)
21. [addsummariestodays](#addsummariestodays)
22. [gentoc](#gentoc)
23. [stitch](#stitch)
24. [addimgtoday](#addimgtoday)
25. [restoreemojis](#restoreemojis)
26. [annotatedayjpgs](#annotatedayjpgs)
27. [addvideo](#addvideo)
28. [genindexrst](#genindexrst)
29. [genstitchmd](#genstitchmd)
